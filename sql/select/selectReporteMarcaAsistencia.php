...
class SelectReporteMarcaAsistencia
{
    ...
    {        
        ...
        if ($this->pdo != null) {
            ...
            $consultaSQL = "SELECT persona.persona_nombre, 
                            tipoMarcaAsistencia.tipoMarcaAsistencia_Descripcion, 
                            ...
                            WHERE Marca_Asistencia_Fecha BETWEEN '".$fechaDesdeFormato."' AND '".$fechaHastaFormato."' 
                            ORDER BY Marca_Asistencia.persona_id, 
                            Marca_Asistencia_Fecha, Marca_Asistencia.tipoMarcaAsistencia_id";                                       
